...
export const getIndividualRegisterFormGroupData = (t) => [
	{
...
export const getOrganizationRegisterFormGroupData = (t) => [
	{
		label: t("form.email"),
		type: "email",
		name: "email",
...
export const getModelProfileFormGroupData = (t) => [
	{
...
export const getVideographerProfileFormGroupData = (t) => [
	{
		label: t("form.cameraOwnedUsed"),
		type: "text",
		name: "camera",
		id: "camera",
	...
	{
		label: t("form.lightningOwnedUsed"),
		type: "text",
		name: "lightning",
		id: "lightning",
		placeholder: "i.e. Nikon",
	...
	{
		label: t("form.stabilizerGimbalAvailability"),
		type: "select",
		name: "stabilizer",
		id: "stabilizer",
		placeholder: "i.e. Nikon",
...
export const getPhotographerProfileFormGroupData = (t) => [
	{
		label: t("form.cameraOwnedUsed"),
		type: "text",
		name: "camera",
...
export const getArtistProfessionalCategories = (t) => [
	{ id: t("profileForms.artist.professionalCategories.painter") },
	{ id: t("profileForms.artist.professionalCategories.sketchArtist") },
	{ id: t("profileForms.artist.professionalCategories.muralArtist") },
	{ id: t("profileForms.artist.professionalCategories.sculptor") },
	{ id: t("profileForms.artist.professionalCategories.digitalArtist") },
];

export const getArtistExpertiseOptions = (t) => [
	{ id: t("profileForms.artist.expertise.realism") },
	{ id: t("profileForms.artist.expertise.abstract") },
	{ id: t("profileForms.artist.expertise.surrealism") },
	{ id: t("profileForms.artist.expertise.portraits") },
	{ id: t("profileForms.artist.expertise.conceptArt") },
	{ id: t("profileForms.artist.expertise.digitalArt") },
];
...
export const getOrgProfileFormGroupData = (t) => [
	{
		label: t("form.bio"),
		type: "text",
		name: "bio",
...
export const getExperienceFormGroupData = (t) => [
	{
		label: t("form.bio"),
		type: "text",
		name: "bio",
	...
	{
		label: t("form.linkYourMostFollowedSocialAccount"),
		type: "text",
		name: "socialAccount",
		id: "socialAccount",
		placeholder: t("form.typeHere"),
	...
	{
		label: t("form.howManyYearsOfExperience"),
		type: "number",
	...
	{
		label: t("form.availableForTravelForShoots"),
		type: "select",
	...
	{
		label: t("form.legallyEligibleToWork"),
		type: "select",
		name: "legallyWorking",
		id: "legallyWorking",
...
export const getJobPostFormGroupData = (t) => [
	{
