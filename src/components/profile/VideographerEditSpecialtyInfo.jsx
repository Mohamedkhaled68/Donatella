...
const VideographerEditSpecialtyInfo = ({ setIsEditing }) => {
	...
	const [formState, setFormState] = useState({
		...
		stabilizer: userSpecialtyInfo.stabilizer || "",
	});
			...
			>
				...
				<div className="flex flex-col gap-2">
					<label
						...
						className="text-white-base font-body font-bold"
					>
						{t("profileEdit.stabilizer")}
					</label>
					<select
						className="bg-[#313131] text-white-base font-body font-bold py-3 px-5 rounded-md"
						value={formState.stabilizer}
						onChange={handleChange}
						id="stabilizer"
						name="stabilizer"
					>
...
export default VideographerEditSpecialtyInfo;
