...
const ModelEditSpecialtyInfo = ({ setIsEditing }) => {
	...
	}, [userStatus.individual.specialtyInfo.birthDate]);
			...
			>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(CountryEnum.enums).map(([label, value]) => (
							<option
								key={value}
								value={value}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(HeightEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(WeightEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(EyeColorEnum.enums).map(([label, value]) => (
							<option
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(SkinToneEnum.enums).map(([label, _value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(HairColorEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(DressSizeEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(ShoeSizeEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(WaistSizeEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(HipSizeEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
				...
				<div className="flex flex-col gap-2">
					...
					<select
						...
						className="bg-[#27292C] border-thin border-white-base/30 text-sm font-light font-body text-white-base rounded-md p-3"
					>
						{Object.entries(BustSizeEnum.enums).map(([label, value]) => (
							<option
								key={label}
								value={label}
							>
