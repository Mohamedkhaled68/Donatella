...
const Models = ({ modelsRef, talentsRef }) => {
    return (
        <>
            <section className="py-10 container mx-auto border-y-4 border-[#fcfcfc0d] font-body">
                <div
                    ref={modelsRef}
                    className=" grid grid-cols-2 justify-items-center gap-x-10"
                >
                    <ModelsCard
                        title="Men"
                        description="Showcase your strength and confidence in every pose."
                        image={manModel}
                        button={"Model As Man"}
                    />
                    <ModelsCard
                    ...
                    <div
                        ref={talentsRef}
                        className=" col-span-2 bg-white mt-10 rounded-br-4 px-10 py-6 flex flex-col gap-5 items-center flex-1 overflow-hidden"
                    >
                        <h1 className="text-6xl font-display text-center">
                            Talent
                        </h1>
                        <p className="text-center text-large font-extralight text-gray-deep w-[40%] mx-auto">
                        ...
                        <div className="relative w-full rounded-3xl overflow-hidden flex items-center">
                            <img
                                className="w-1/3 object-cover h-full filter grayscale"
                                src={talent1}
                                alt="talent1"
                            />
                            <img
                                className="w-1/3 object-cover h-full border-x-4 border-slate-700 filter grayscale"
                                src={talent2}
                                alt="talent2"
                            />
                            <img
                            ...
                            <div className="w-[calc(100%-4px)] h-[calc(100%-4px)] bg-black/70 group-hover:bg-black/0 duration-400 rounded-3xl absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-white flex justify-center items-center">
                                <div className="flex flex-col gap-10 items-center">
                                    <h1 className="text-6xl leading-[65px] font-display w-[70%] mx-auto font-extrabold text-center">
                                        Access to top industry professionals
                                    </h1>
                                    <p className="text-large text-white-base/75 font-display w-[60%] mx-auto font-[400] text-center">
