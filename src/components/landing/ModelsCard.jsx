...
const ModelsCard = ({ title, description, image, button, isMobile, setOpenNote, openNote, cardId, token }) => {
	...
	return (
		<div className="bg-white relative col-span-1 py-4 px-10 h-full rounded-br-4 flex flex-col items-center justify-center gap-5">
			...
			<p className="text-center text-[14px] lg:text-lg font-extralight">{description}</p>
